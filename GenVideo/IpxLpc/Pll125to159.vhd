...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n Pll125to159 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 157.5 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 13.125 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw 
...
architecture Structure of Pll125to159 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "157.500000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "100.000000";
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "13.125000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  12, CLKOP_DIV=>  4, CLKFB_DIV=>  63, CLKI_DIV=>  40, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of Pll125to159 is
    for Structure
