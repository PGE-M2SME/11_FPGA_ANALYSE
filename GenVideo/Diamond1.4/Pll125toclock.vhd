...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n Pll125toclock -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 125 -phase_cntl STATIC -fclkop 110 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 55 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw 
...
architecture Structure of Pll125toclock is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "110.000000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "125.000000";
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "55.000000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  8, CLKFB_DIV=>  22, CLKI_DIV=>  25, 
        FIN=> "125.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of Pll125toclock is
    for Structure
