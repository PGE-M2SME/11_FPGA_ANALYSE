...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n PllClkto120 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 120 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 60 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw 

-- Tue Feb 16 22:31:18 2021
...
architecture Structure of PllClkto120 is
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  8, CLKFB_DIV=>  6, CLKI_DIV=>  5, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of PllClkto120 is
    for Structure
