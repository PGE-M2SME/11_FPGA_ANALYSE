...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n PllClkto34 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 34 -fclkop_tol 0.2 -fb_mode CLOCKTREE -noclkos -fclkok 17.00 -fclkok_tol 0.2 -clkoki 0 -norst -noclkok2 -bw 

-- Wed Feb 17 00:55:47 2021
...
architecture Structure of PllClkto34 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "34.042553";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "100.000000";
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "17.021277";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  16, CLKFB_DIV=>  16, CLKI_DIV=>  47, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of PllClkto34 is
    for Structure
