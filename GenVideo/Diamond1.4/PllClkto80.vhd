...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n PllClkto80 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 80 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 40 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw 
...
architecture Structure of PllClkto80 is
    ...
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "40.000000";
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of PllClkto80 is
    for Structure
