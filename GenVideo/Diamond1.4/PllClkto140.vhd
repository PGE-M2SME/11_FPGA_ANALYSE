...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n PllClkto140 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 140 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 70 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw 

-- Tue Feb 16 22:34:51 2021
...
architecture Structure of PllClkto140 is
    ...
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "70.000000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  7, CLKI_DIV=>  5, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of PllClkto140 is
    for Structure
