-- =============================================================================
--  VHDL simulation model generated by IPExpress    02/16/2021    21:13:23         
--  Filename: testvideotop_la0_sim.vhd                                          
...
entity testvideotop_la0 is
    PORT (
        ...
        trace_din:	IN std_logic_vector (59 downto 0);
        trigger_en:	IN std_logic;
        ip_enable:	IN std_logic
    );

end testvideotop_la0;

architecture testvideotop_la0_u of testvideotop_la0 is
begin

    er2_tdo <= '0';

end testvideotop_la0_u;
